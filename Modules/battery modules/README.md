...
| `AA_AAA dry battery modified to lithium battery 3V-4.2V reduced by 1.5V` | <img src="./AA_AAA dry battery modified to lithium battery 3V-4.2V reduced by 1.5V/Se2403a4270644fe3a738096ad8ea9fbcl.webp" width="120"/> | Adapter / Converter | Single cell | Converts 3.7–4.2V Li to ~1.5V for AA/AAA form-factor devices | image only |
