# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 365 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c" 2
# 26 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_rcm.h" 1
# 33 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_rcm.h"
...
# 34 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_rcm.h" 2
...
# 27 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c" 2
# 47 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_Reset(void)
{

    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.HSIEN = BIT_SET;
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1 &= (uint32_t)0x08FFB80C;
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1 &= (uint32_t)0xFEF6FFFF;
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.HSEBCFG = BIT_RESET;
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1 &= (uint32_t)0xFFC0FFFF;
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG2 &= (uint32_t)0xFFFFFFF0;
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3 &= (uint32_t)0xFFF0FEAC;
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2_B.HSI14EN= BIT_RESET;


    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->INT = 0x00FF0000;
}
# 75 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigHSE(RCM_HSE_T state)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.HSEEN = BIT_RESET;
    ...
    {
        ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.HSEBCFG = BIT_SET;
        ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.HSEEN = BIT_SET;
    }
}
# 100 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint8_t RCM_WaitHSEReady(void)
{
    volatile uint32_t cnt;

    for (cnt = 0; cnt < ((uint32_t)0x10000); cnt++)
    {
        if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.HSERDYFLG == BIT_SET)
        {
            return SUCCESS;
        }
    }
...
# 123 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_SetHSITrim(uint8_t HSITrim)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.HSITRM = HSITrim;
}
# 137 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableHSI(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.HSIEN = BIT_SET;
}
# 151 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableHSI(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.HSIEN = BIT_RESET;
}
# 164 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_SetHSI14Trim(uint8_t HSI14Trim)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2_B.HSI14TRM = HSI14Trim;
}
# 178 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableHSI14(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2_B.HSI14EN = BIT_SET;
}
# 192 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableHSI14(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2_B.HSI14EN = BIT_RESET;
}
# 206 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableHSI14ADC(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2_B.HSI14TO = BIT_SET;
}
# 220 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableHSI14ADC(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2_B.HSI14TO = BIT_RESET;
}
# 237 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigLSE(RCM_LSE_T state)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.LSEEN = BIT_RESET;

    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.LSEBCFG = BIT_RESET;

    if (state == RCM_LSE_OPEN)
    {
        ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.LSEEN = BIT_SET;
    }
    else if (state == RCM_LSE_BYPASS)
    {
        ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.LSEBCFG = BIT_SET;
        ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.LSEEN = BIT_SET;
    }
}
# 268 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigDriveLSE(RCM_LSE_DRIVE_T state)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.LSEDRVCFG = state;
}
# 282 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableLSI(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CSTS_B.LSIEN = BIT_SET;
}
# 296 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableLSI(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CSTS_B.LSIEN = BIT_RESET;
}
# 318 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigPLL(RCM_PLL_SEL_T pllSelect, RCM_PLLMF_T pllMf)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.PLLMULCFG = pllMf;
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.PLLSRCSEL = pllSelect;
}
# 333 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnablePLL(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.PLLEN = BIT_SET;
}
# 347 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisablePLL(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.PLLEN = BIT_RESET;
}
# 361 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableHSI48(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2_B.HSI48EN = BIT_SET;
}
# 375 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableHSI48(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2_B.HSI48EN = BIT_RESET;
}
# 387 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadHSI48CalibrationValue(void)
{
    uint32_t calValue;

    calValue = ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2_B.HSI48CAL;

    return calValue;
}
# 405 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigCLKDIV(RCM_CLK_DIV_T state)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG2_B.PLLDIVCFG = state;
}
# 417 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableCCS(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.CSSEN = BIT_SET;
}
# 429 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableCCS(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1_B.CSSEN = BIT_RESET;
}
# 451 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigCOC(RCM_COCCLK_T cocClock)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.MCOSEL = cocClock;
}
# 515 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigSYSCLK(RCM_SYSCLK_SEL_T sysClkSelect)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.SCLKSEL = sysClkSelect;
}
# 527 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
RCM_SYSCLK_SEL_T RCM_ReadSYSCLKSource(void)
{
    RCM_SYSCLK_SEL_T sysClock;

    sysClock = (RCM_SYSCLK_SEL_T)((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.SCLKSWSTS;

    return sysClock;
}
# 553 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigAHB(RCM_AHBDIV_T AHBDiv)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.AHBPSC = AHBDiv;
}
# 571 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigAPB(RCM_APBDIV_T APBDiv)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.APB1PSC = APBDiv;
}
# 587 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigCECCLK(RCM_CECCLK_T CECClk)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.CECSEL = CECClk;
}
# 603 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigI2CCLK(RCM_I2CCLK_T I2CClk)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.I2C1SEL = I2CClk;
}
# 631 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigUSARTCLK(RCM_USARTCLK_T USARTClk)
{
    if(USARTClk >> 16 == 1)
    {
        ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART1SEL = (uint32_t)(USARTClk & 0x00000003);
    }
    else if(USARTClk >> 17 == 1)
    {
        ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART2SEL = (uint32_t)(USARTClk & 0x00000003);
    }
    else
    {
        ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART3SEL = (uint32_t)(USARTClk & 0x00000003);
    }
}
# 660 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigUSBCLK(RCM_USBCLK_T USBClk)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USBDSEL = USBClk;
}
# 672 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadSYSCLKFreq(void)
{
    uint32_t sysClock, pllMull,plldiv,pllSource;

    sysClock = ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.SCLKSEL;

    switch (sysClock)
    {
        case RCM_SYSCLK_SEL_HSI:
            sysClock = ((uint32_t)8000000);
            break;
        ...
        case RCM_SYSCLK_SEL_PLL:
            ...
            plldiv = ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG2_B.PLLDIVCFG + 1;

            if (pllSource == 0x00)
            {
                sysClock = ((((uint32_t)8000000) >> 1) / plldiv) * pllMull;
            }
            else if(pllSource == 0x01)
            {
                sysClock = (((uint32_t)8000000) / plldiv) * pllMull;
            }
            ...
            {
                sysClock = (((uint32_t)48000000) / plldiv) * pllMull;
            }
            break;

        case RCM_SYSCLK_SEL_HSI48:
            sysClock = ((uint32_t)48000000);
            break;
...
# 730 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadHCLKFreq(void)
{
    uint32_t divider;
    ...
    divider = AHBPrescTable[((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.AHBPSC];
    hclk = sysClk >> divider;

    return hclk;
}
# 750 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadPCLKFreq(void)
{
    ...
    divider = APBPrescTable[((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.APB1PSC];
    pclk = hclk >> divider;

    return pclk;

}
# 771 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadADCCLKFreq(void)
{
    ...
    if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.ADCSEL)
    {
        if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.ADCPSC)
        {
            adcClk=pclk >> 2;
        }
        else
    ...
    {
        adcClk=((uint32_t)14000000);
    }

    return adcClk;
}
# 803 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadCECCLKFreq(void)
{
    uint32_t cecClk;

    if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.CECSEL)
    {
        cecClk = ((uint32_t)32768);
    }
    else
    {
        cecClk = ((uint32_t)40000) / 244;
    }

    return cecClk;
}
# 826 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadI2C1CLKFreq(void)
{
    ...
    if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.I2C1SEL)
    {
        i2c1Clk = sysClk;
    }
    else
    {
        i2c1Clk = ((uint32_t)8000000);
    }

    return i2c1Clk;
}
# 851 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadUSART1CLKFreq(void)
{
    uint32_t usart1Clk;

    if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART1SEL==0x00)
    {
        usart1Clk = RCM_ReadPCLKFreq();
    }
    else if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART1SEL==0x01)
    {
        usart1Clk = RCM_ReadSYSCLKFreq();
    }
    else if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART1SEL==0x02)
    {
        usart1Clk = ((uint32_t)32768);
    }
    else if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART1SEL==0x03)
    {
        usart1Clk = ((uint32_t)8000000);
    }

    return usart1Clk;
}
# 882 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadUSBCLKFreq(void)
{
    uint32_t usbClk,pllClk,pllMull,clkDiv;

    if(((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.SCLKSWSTS & 0x02)
    {
        pllMull = ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.PLLMULCFG;
        pllMull = pllMull+2;
    }

    if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USBDSEL)
    {
        if(((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG1_B.PLLSRCSEL == 0x00)
        {
            pllClk = (((uint32_t)8000000) >>1) * pllMull;
        }
        else
        {
            clkDiv = (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG2_B.PLLDIVCFG)+1;
            pllClk = (((uint32_t)8000000) / clkDiv) * pllMull;
        }
        usbClk = pllClk;
    }
    else
    {
        usbClk = ((uint32_t)48000000);
    }

    return usbClk;
}
# 920 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint32_t RCM_ReadUSART2CLKFreq(void)
{
    uint32_t usart1Clk;

    if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART2SEL==0x00)
    {
        usart1Clk = RCM_ReadPCLKFreq();
    }
    else if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART2SEL==0x01)
    {
        usart1Clk = RCM_ReadSYSCLKFreq();
    }
    else if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART2SEL==0x02)
    {
        usart1Clk = ((uint32_t)32768);
    }
    else if (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFG3_B.USART2SEL==0x03)
    {
        usart1Clk = ((uint32_t)8000000);
    }
...
# 957 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ConfigRTCCLK(RCM_RTCCLK_T RTCClk)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.RTCSRCSEL = RTCClk;
}
# 969 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableRTCCLK(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.RTCCLKEN = BIT_SET;
}
# 981 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableRTCCLK(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.RTCCLKEN = BIT_RESET;
}
# 993 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableBackupReset(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.BDRST = BIT_SET;
}
# 1005 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableBackupReset(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL_B.BDRST = BIT_RESET;
}
# 1030 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableAHBPeriphClock(uint32_t AHBPeriph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->AHBCLKEN |= AHBPeriph;
}
# 1055 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableAHBPeriphClock(uint32_t AHBPeriph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->AHBCLKEN &= (uint32_t)~AHBPeriph;
}
# 1080 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableAPB2PeriphClock(uint32_t APB2Periph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APBCLKEN2 |= APB2Periph;
}
# 1105 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableAPB2PeriphClock(uint32_t APB2Periph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APBCLKEN2 &= (uint32_t)~APB2Periph;
}
# 1137 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableAPB1PeriphClock(uint32_t APB1Periph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APBCLKEN1 |= APB1Periph;
}
# 1169 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableAPB1PeriphClock(uint32_t APB1Periph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APBCLKEN1 &= (uint32_t)~APB1Periph;
}
# 1189 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableAHBPeriphReset(uint32_t AHBPeriph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->AHBRST |= AHBPeriph;
}
# 1209 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableAHBPeriphReset(uint32_t AHBPeriph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->AHBRST &= (uint32_t)~AHBPeriph;
}
# 1241 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableAPB1PeriphReset(uint32_t APB1Periph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APBRST1 |= APB1Periph;
}
# 1273 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableAPB1PeriphReset(uint32_t APB1Periph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APBRST1 &= (uint32_t)~APB1Periph;
}
# 1298 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableAPB2PeriphReset(uint32_t APB2Periph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APBRST2 |= APB2Periph;
}
# 1323 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableAPB2PeriphReset(uint32_t APB2Periph)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APBRST2 &= (uint32_t)~APB2Periph;
}
# 1343 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_EnableInterrupt(uint8_t interrupt)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->INT |= (interrupt << 8);
}
# 1363 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_DisableInterrupt(uint8_t interrupt)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->INT &= ~(interrupt << 8);
}
# 1391 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint16_t RCM_ReadStatusFlag(RCM_FLAG_T flag)
{
    uint32_t reg, bit;
    ...
    {
        case 0:
            reg = ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL1;
            break;

        case 1:
            reg = ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->BDCTRL;
            break;

        case 2:
            reg = ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CSTS;
            break;

        case 3:
            reg = ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CTRL2;
            break;
...
# 1440 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ClearStatusFlag(void)
{
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CSTS_B.RSTFLGCLR = BIT_SET;
}
# 1461 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
uint8_t RCM_ReadIntFlag(RCM_INT_T flag)
{
    uint8_t ret;

    ret = (((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->INT& flag) ? SET : RESET;

    return ret;
}
# 1486 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_rcm.c"
void RCM_ClearIntFlag(uint8_t flag)
{
    uint32_t temp;

    temp = flag << 16;
    ((RCM_T*) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->INT |= temp;
}
