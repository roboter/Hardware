# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 365 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c" 2
# 26 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_gpio.h" 1
# 33 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_gpio.h"
...
# 34 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_gpio.h" 2
...
# 27 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c" 2
...
# 138 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
void GPIO_ConfigStructInit(GPIO_Config_T* gpioConfig)
{
...
# 156 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
void GPIO_ConfigPinLock(GPIO_T* port, uint16_t pin)
{
...
# 184 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
uint8_t GPIO_ReadInputBit(GPIO_T* port, uint16_t pin)
{
    uint8_t ret;
...
# 202 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
uint16_t GPIO_ReadInputPort(GPIO_T* port)
{
    return ((uint16_t)port->IDATA);
}
# 218 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
uint8_t GPIO_ReadOutputBit(GPIO_T* port, uint16_t pin)
{
...
# 237 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
uint16_t GPIO_ReadOutputPort(GPIO_T* port)
{
    return ((uint16_t)port->ODATA);
}
# 253 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
void GPIO_SetBit(GPIO_T* port, uint16_t pin)
{
    port->BSC = (uint32_t)pin;
}
# 269 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
void GPIO_ClearBit(GPIO_T* port, uint16_t pin)
{
    port->BR = (uint32_t)pin;
}
# 287 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
void GPIO_WriteBitValue(GPIO_T* port, uint16_t pin, GPIO_BSRET_T bitVal)
{
    if (bitVal != Bit_RESET)
    {
...
# 310 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
void GPIO_WriteOutputPort(GPIO_T* port, uint16_t portValue)
{
    port->ODATA = (uint32_t)portValue;
}
# 332 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_gpio.c"
void GPIO_ConfigPinAF(GPIO_T* port, GPIO_PIN_SOURCE_T pinSource, GPIO_AF_T afPin)
{
    uint32_t temp = 0x00;
    uint32_t temp1 = 0x00;
