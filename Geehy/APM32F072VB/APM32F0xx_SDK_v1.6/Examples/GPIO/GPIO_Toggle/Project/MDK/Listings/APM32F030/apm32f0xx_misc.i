# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 365 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c" 2
# 26 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_misc.h" 1
# 34 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_misc.h"
...
# 35 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_misc.h" 2
...
# 27 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c" 2
# 53 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
void NVIC_EnableIRQRequest(IRQn_Type irq, uint8_t priority)
{
...
# 67 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
void NVIC_DisableIRQRequest(IRQn_Type irq)
{
    NVIC_DisableIRQ(irq);
}
# 83 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
void NVIC_EnableSystemLowPower(uint8_t lowPowerMode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= lowPowerMode;
}
# 99 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
void NVIC_DisableSystemLowPower(uint8_t lowPowerMode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= (uint32_t)(~(uint32_t)lowPowerMode);
}
# 114 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
void SysTick_ConfigCLKSource(uint32_t sysTickCLKSource)
{
    if (sysTickCLKSource == ((uint32_t)0x00000004))
    {
...
# 133 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
void PMU_EnterWaitMode(void)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= (uint32_t)(~(uint32_t)NVIC_LOWPOER_SLEEPDEEP);
    __WFI();
}
# 146 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
void PMU_EnterHaltModeWFI(void)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= NVIC_LOWPOER_SLEEPDEEP;
    __DSB();
    __WFI();
}
# 160 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_misc.c"
void PMU_EnterHaltModeWFE(void)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= NVIC_LOWPOER_SLEEPDEEP;
    __DSB();
