# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 365 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c" 2
# 26 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
# 1 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_eint.h" 1
# 33 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_eint.h"
...
# 34 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_eint.h" 2
# 50 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_eint.h"
typedef enum
{
...
# 132 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_eint.h"
typedef struct
{
    uint32_t line;
    EINT_MODE_T mode;
...
# 147 "../../../../../Library/APM32F0xx_StdPeriphDriver/inc\\apm32f0xx_eint.h"
...
# 27 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c" 2
# 47 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
void EINT_Reset(void)
{
    ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->IMASK = ((uint32_t)(0x0F940000));
    ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->EMASK = ((uint32_t)(0x00000000));
    ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->RTEN = ((uint32_t)(0x00000000));
    ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->FTEN = ((uint32_t)(0x00000000));
    ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->IPEND = ((uint32_t)(0x00000000));
}
# 64 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
void EINT_Config( EINT_Config_T* eintConfig)
{
    if (eintConfig->lineCmd == DISABLE)
    {
        ...
        {
            ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->IMASK &= ~eintConfig->line;
        }
        else if (eintConfig->mode == EINT_MODE_EVENT)
        {
            ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->EMASK &= ~eintConfig->line;
        }
    }
    else
    {
        ...
        {
            ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->RTEN |= eintConfig->line;
        }
        else if (eintConfig->trigger == EINT_TRIGGER_FALLING)
        {
            ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->FTEN |= eintConfig->line;
        }
        else
        {
            ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->RTEN |= eintConfig->line;
...
# 112 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
void EINT_ConfigStructInit(EINT_Config_T* eintConfig)
{
    eintConfig->line = ((uint32_t)0x00000);
    eintConfig->mode = EINT_MODE_INTERRUPT;
    eintConfig->trigger = EINT_TRIGGER_FALLING;
    eintConfig->lineCmd = DISABLE;
}
# 127 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
void EINT_SelectSWInterrupt(uint32_t line)
{
    ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->SWINTE |= (uint32_t)line;
}
# 139 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
uint8_t EINT_ReadStatusFlag(uint32_t line)
{
    uint8_t status = RESET;

    if ((((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->IPEND & line) != (uint32_t)RESET)
    {
        status = SET;
    }
    else
...
# 162 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
void EINT_ClearStatusFlag(uint32_t line)
{
    ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->IPEND = line;
}
# 174 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
uint8_t EINT_ReadIntFlag(uint32_t line)
{
    uint8_t status = RESET;
    uint32_t enablestatus = 0;

    enablestatus = ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->IMASK & line;

    if ((((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->IPEND & line) != ((uint32_t)RESET) && (enablestatus != (uint32_t)RESET))
    {
        status = SET;
    }
    else
...
# 200 "../../../../../Library/APM32F0xx_StdPeriphDriver/src/apm32f0xx_eint.c"
void EINT_ClearIntFlag(uint32_t line)
{
    ((EINT_T*) (((uint32_t)0x40000000) + 0x00010400))->IPEND = line;
}
