...
/** @addtogroup Common_Parameters_Number_Of_Elements
  @{
*/
...
/** @addtogroup Common_Parameters_Optional_Features
  @{
*/
...
/** @addtogroup Common_Parameters_Acquisition_limits
  @{
*/
...
/** @addtogroup Common_Parameters_Calibration
  @{
*/
...
/** @addtogroup Common_Parameters_Thresholds_for_TouchKey
  @{
*/
...
/** @addtogroup Common_Parameters_Thresholds_For_Linear_Rotary
  @{
*/
...
/** @addtogroup Common_Parameters_Used_Linear_Rotary
  @{
*/
...
/** @addtogroup Common_Parameters_Position_Linear_Rotary
  @{
*/
...
/** @addtogroup Common_Parameters_Debounce_Counters
  @{
*/
...
/** @addtogroup Common_Parameters_Environment_Change_System (ECS)
  @{
*/
...
/** @addtogroup Common_Parameters_Detection_Time_Out (DTO)
  @{
*/
...
/** @addtogroup Common_Parameters_Detection_Exclusion_System (DXS)
  @{
*/
...
/** @addtogroup Common_Parameters_Miscellaneous_Parameters
  @{
*/
...
/** @addtogroup APM32F0xx_Parameters_GPIOs_Configuration
  @{
*/
...
/** @addtogroup APM32F0xx_Parameters_Charge_Transfer_Pulses
  @{
*/
...
/** @addtogroup APM32F0xx_Parameters_GPIOs
  @{
*/
