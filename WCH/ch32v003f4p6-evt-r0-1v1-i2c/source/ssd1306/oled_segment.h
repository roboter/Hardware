...
#define	OLED_EXP_MEM_HORIZONTAL_ADDR_MODE	0x00
#define	OLED_EXP_MEM_VERTICAL_ADDR_MODE		0x01
#define	OLED_EXP_MEM_PAGE_ADDR_MODE				0x02
//} eOledExpMemoryMode;
...
void OLED_printc(uint8_t c);       // OLED write a character
