...
static const uint8_t font_symbols[][5] = {
   // {0x0C,0x0A,0x09,0x0A,0x0C}, // ▲ 2  pixel step
    {0xC0, 0xF0, 0xFC, 0xF0, 0xC0},
    {0x0C, 0x3C, 0xFC, 0x3C, 0x0C}, // ▼
    {0xF8,0x00,0x00,0x00,0x00},  // heart
    {0xFF,0xFF,0xFF,0xFF,0xFF}, // CURSOR
    {0x80, 0xC0, 0xE0, 0xC0, 0x80},  // ▲ 1 pixel step
    {0x20, 0x60, 0xE0, 0x60, 0x20}, //  ▼ 1 pixel step
};
