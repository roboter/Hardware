# 1 "../../../Utilities/gd32e230c_start.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../Utilities/gd32e230c_start.c" 2
# 36 "../../../Utilities/gd32e230c_start.c"
# 1 "../../../Utilities/gd32e230c_start.h" 1
# 43 "../../../Utilities/gd32e230c_start.h"
...
# 44 "../../../Utilities/gd32e230c_start.h" 2
...
# 37 "../../../Utilities/gd32e230c_start.c" 2
...
static const uint32_t GPIO_PIN[4U] = {((uint32_t)((uint32_t)0x01U<<(7))),
...
static const uint32_t KEY_PORT[1U] = {((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U)};

static const uint32_t KEY_PIN[1U] = {((uint32_t)((uint32_t)0x01U<<(0)))};

static const rcu_periph_enum KEY_CLK[1U] = {RCU_GPIOA};

static const exti_line_enum KEY_EXTI_LINE[1U] = {EXTI_0};

static const uint8_t KEY_PORT_SOURCE[1U] = {((uint8_t)0x00U)};

static const uint8_t KEY_PIN_SOURCE[1U] = {((uint8_t)0x00U)};

static const uint8_t KEY_IRQn[1U] = {EXTI0_1_IRQn};
# 79 "../../../Utilities/gd32e230c_start.c"
void gd_eval_led_init(led_typedef_enum lednum)
{
...
# 100 "../../../Utilities/gd32e230c_start.c"
void gd_eval_led_on(led_typedef_enum lednum)
{
    (*(volatile uint32_t *)(uint32_t)((GPIO_PORT[lednum]) + 0x18U)) = GPIO_PIN[lednum];
}
# 115 "../../../Utilities/gd32e230c_start.c"
void gd_eval_led_off(led_typedef_enum lednum)
{
    (*(volatile uint32_t *)(uint32_t)((GPIO_PORT[lednum]) + 0x28U)) = GPIO_PIN[lednum];
}
# 130 "../../../Utilities/gd32e230c_start.c"
void gd_eval_led_toggle(led_typedef_enum lednum)
{
    (*(volatile uint32_t *)(uint32_t)((GPIO_PORT[lednum]) + 0x2CU)) = GPIO_PIN[lednum];
}
# 147 "../../../Utilities/gd32e230c_start.c"
void gd_eval_key_init(key_typedef_enum keynum, keymode_typedef_enum keymode)
{
    ...
    gpio_mode_set(KEY_PORT[keynum], (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), KEY_PIN[keynum]);
...
# 178 "../../../Utilities/gd32e230c_start.c"
uint8_t gd_eval_key_state_get(key_typedef_enum keynum)
{
