...
add_library(Group_GD32E230_START OBJECT
  "${SOLUTION_ROOT}/../../../Utilities/gd32e230k_start.c"
)
target_include_directories(Group_GD32E230_START PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_INCLUDE_DIRECTORIES>
)
target_compile_definitions(Group_GD32E230_START PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_COMPILE_DEFINITIONS>
)
add_library(Group_GD32E230_START_ABSTRACTIONS INTERFACE)
target_link_libraries(Group_GD32E230_START_ABSTRACTIONS INTERFACE
  ${CONTEXT}_ABSTRACTIONS
)
target_compile_options(Group_GD32E230_START PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_COMPILE_OPTIONS>
)
target_link_libraries(Group_GD32E230_START PUBLIC
  Group_GD32E230_START_ABSTRACTIONS
)
