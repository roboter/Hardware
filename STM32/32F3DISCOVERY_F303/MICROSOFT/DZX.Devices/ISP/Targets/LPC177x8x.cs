...
{
    internal static class LPC17x8x
    {
        public static void ConfigureTarget(ISPTarget target)
        {
            target.RAMBufferAddress = 0x10004000;
            ...
            switch (target.DeviceType)
            {
                ...
                case ISPDeviceType.LPC1786:
                case ISPDeviceType.LPC1785:
                case ISPDeviceType.LPC1776:
                    // 256 KB parts
                    target.MemoryMap.Sections.Add(new MemoryMapSection(0x00000000, 0, 0x1000, 16));
                    target.MemoryMap.Sections.Add(new MemoryMapSection(0x00010000, 16, 0x8000, 6));
                    break;

                case ISPDeviceType.LPC1788:
                case ISPDeviceType.LPC1787:
                case ISPDeviceType.LPC1778:
                case ISPDeviceType.LPC1777:
                    // 512 KB parts
                    target.MemoryMap.Sections.Add(new MemoryMapSection(0x00000000, 0, 0x1000, 16));
