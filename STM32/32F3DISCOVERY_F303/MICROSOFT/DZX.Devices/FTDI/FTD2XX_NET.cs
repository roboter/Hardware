...
namespace FTD2XX_NET
{
	...
	public class FTDI
	{
		...
		// _handle to our DLL - used with GetProcAddress to load all of our functions
		...
		/// <param name="eventhandle">_handle to the event that will receive the notification</param>
