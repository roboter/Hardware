/*******************************************************************************************************************************************
    ...
    DZX | LPC1857-MCB | USB-BOOT                                                                                          VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
static void APP_Main(void* arg)
{
    ...
    TIMER_Create(&timer,                                        /* Create a timer for blinking LED */
                 "LED",                                         /* The name for the timer */
                 CALLBACK_Timer,                                /* The function to be called upon expiration of the timer */
    ...
    IAP_Initialize();                                           /* Initialize the IAP interface for programming the internal flash */
...
static void APP_InitUSB(void)
{
    ...
    status = USBD_SetDeviceName(&usbd,                          /* Assign name strings for the device */
                                ...
                                "LPC1857 BOOTLOADER",           /* Product Name */
                                NULL);                          /* Serial Number */
