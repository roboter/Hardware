/*******************************************************************************************************************************************
    ...
    DZX | LPC1769-LPCX | DATALINK                                                                                         VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------

    This is an application that implements a demonstration data link on the LPC1769 LPCXpresso evaluation board. The application
    provides the link over native USB and over UART 3 (FTDI connector).
...
static void APP_Timer1(TIMER* timer, void* arg)
{
    ...
    if (TIMER_IsRunning(&timer2)) {                             /* Blink the LED based upon whether the stream is enabled */
...
static void APP_Main(void* arg)
{
    ...
    PIN_SetFunction(P0_00, 2);                          /* Assign P0.0 to the TXD3 function */
    PIN_SetFunction(P0_01, 2);                          /* Assign P0.1 to the RXD3 function */
