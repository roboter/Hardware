/*******************************************************************************************************************************************
    ...
    DZX | LPC18S37-LPCX | LED                                                                                             VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
/*******************************************************************************************************************************************
    LOCAL CONFIGURATION
*******************************************************************************************************************************************/
#define CFG_LEDREDPIN           P6_11
#define CFG_LEDGREENPIN         P2_07
#define CFG_LEDBLUEPIN          P6_09
...
/***************************************************************************************************************************************//**
    ...
    @return     None.
    @module     BOARD-LED-LPC18S37-LPCX

*******************************************************************************************************************************************/
void LED_Init(void)
{
    PIN_SetFunction(CFG_LEDREDPIN, 0);                          /* Configure the LED pins for GPIO */
    PIN_SetFunction(CFG_LEDGREENPIN, 0);
    PIN_SetFunction(CFG_LEDBLUEPIN, 0);
