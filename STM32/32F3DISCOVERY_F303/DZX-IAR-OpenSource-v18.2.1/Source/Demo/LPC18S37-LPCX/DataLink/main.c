/*******************************************************************************************************************************************
    ...
    DZX | LPC18S37-LPCX | DATALINK                                                                                        VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------

    This is an application that implements a demonstration data link on the LPC18S37 LPCXpresso evaluation board. The application
    provides the link over native USB and over UART 0 (FTDI connector).
...
static void APP_Main(void* arg)
{
    ...
    PIN_SetFunction(P6_04, 2);                          /* Assign P6.4 to the U0_TXD function */
    PIN_SetFunction(P2_01, 1);                          /* Assign P2.1 to the U0_RXD function */
    PIN_SetInputBuffer(P2_01, TRUE);
