...
/***************************************************************************************************************************************//**
    ...
    Represents the available LEDs for the board.
    @module     BOARD-LED-LPC1549-LPCX

*******************************************************************************************************************************************/
typedef enum LED {
    LED_RED = 0,            /**< The red LED within the RGB LED */
    LED_GREEN,              /**< The green LED within the RGB LED */
    LED_BLUE                /**< The blue LED within the RGB LED */
} LED;
