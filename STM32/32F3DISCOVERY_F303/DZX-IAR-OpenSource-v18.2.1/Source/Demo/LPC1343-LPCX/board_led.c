/*******************************************************************************************************************************************
    ...
    DZX | LPC1343-LPCX | LED                                                                                              VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
/***************************************************************************************************************************************//**
    ...
    @return     None.
    @module     BOARD-LED-LPC1343-LPCX

*******************************************************************************************************************************************/
void LED_Init(void)
{
    PIN_SetDirection(CFG_LEDPIN, DIRECTION_OUTPUT);             /* Configure the pin as an output to drive the LED */
    LED_Set(FALSE);                                             /* Begin with the LED off */
}
...
STATUS LED_SetSevenSegment(SEVENSEGMENT* seg, CHAR ch)
{
    ...
    status = SPI_Write(seg->spi, &val, 1, 100);            /* Write the segment data */
