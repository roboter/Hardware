/*******************************************************************************************************************************************
    ...
    DZX | LPC1343-LPCX | UART ECHO                                                                                        VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
static void APP_Main(void* arg)
{
    ...
    PIN_SetFunction(P1_07, 1);                          /* Assign P1.7 to the TXD function */
    PIN_SetFunction(P1_06, 1);                          /* Assign P1.6 to the RXD function */
