...
*******************************************************************************************************************************************/
#define CFG_TSTICKSPERSECOND        72000000

/*******************************************************************************************************************************************

    DEFAULT TIME SLICE              The initial time slice value, in kernel ticks, for each thread created within the kernel. Must be
...
/*******************************************************************************************************************************************
    ...
    THREAD LIST LOCK TIMEOUT        The timeout value used when attempting to acquire a lock guarding the kernel thread list.

*******************************************************************************************************************************************/
#define CFG_THREADLISTLOCKTIMEOUT   INFINITE
