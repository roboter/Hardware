/*******************************************************************************************************************************************
    ...
    DZX | LPC1788-OEM | DATALINK                                                                                          VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------

    This is an application that implements a demonstration data link on the Embedded Artists LPC1788 OEM evaluation board. The 
    application provides the link over native USB and over UART 0 (FTDI connector).
...
static void APP_Timer1(TIMER* timer, void* arg)
{
    ...
    if (TIMER_IsRunning(&timer2)) {                             /* Timer running indicates whether streaming device status */
        ...
        LED_Set(LED_RED, FALSE);                                /* Blink green LED while streaming device status */
