...
*******************************************************************************************************************************************/
#define REG_UART0      ((REG_UART*)0x40081000)
#define REG_UART1      ((REG_UART*)0x40082000)
#define REG_UART2      ((REG_UART*)0x400C1000)
#define REG_UART3      ((REG_UART*)0x400C2000)
...
/*******************************************************************************************************************************************
    TYPE DEFINITIONS
*******************************************************************************************************************************************/
typedef struct LPC43XX_UART UART;
typedef enum LPC43XX_STOPBITS STOPBITS;
typedef enum LPC43XX_PARITY PARITY;
typedef enum LPC43XX_HANDSHAKE HANDSHAKE;
