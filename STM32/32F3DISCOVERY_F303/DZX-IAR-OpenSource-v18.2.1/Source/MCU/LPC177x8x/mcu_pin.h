...
*******************************************************************************************************************************************/
#define REG_GPIO0          ((REG_GPIO*)(0x20098000))   /* The GPIO registers for port 0 */
#define REG_GPIO1          ((REG_GPIO*)(0x20098020))   /* The GPIO registers for port 1 */
#define REG_GPIO2          ((REG_GPIO*)(0x20098040))   /* The GPIO registers for port 2 */
#define REG_GPIO3          ((REG_GPIO*)(0x20098060))   /* The GPIO registers for port 3 */
#define REG_GPIO4          ((REG_GPIO*)(0x20098080))   /* The GPIO registers for port 4 */
#define REG_GPIO5          ((REG_GPIO*)(0x200980A0))   /* The GPIO registers for port 4 */

#define REG_IOCON(port, pin) ((volatile UINT32*)(0x4002C000 + (port * 0x80) + (pin * 4)))
...
/*******************************************************************************************************************************************
    TYPE DEFINITIONS
*******************************************************************************************************************************************/
typedef enum LPC177X8X_PORT PORT;
typedef enum LPC177X8X_PIN PIN;
typedef enum LPC177X8X_DIRECTION DIRECTION;
typedef enum LPC177X8X_MODE MODE;
typedef enum LPC177X8X_EDGE EDGE;
...
*******************************************************************************************************************************************/
extern BOOLEAN PIN_Hysteresis(PIN pin);
...
*******************************************************************************************************************************************/
extern void PIN_SetHysteresis(PIN pin, BOOLEAN enabled);
...
*******************************************************************************************************************************************/
extern BOOLEAN PIN_InvertPolarity(PIN pin);
...
*******************************************************************************************************************************************/
extern void PIN_SetInvertPolarity(PIN pin, BOOLEAN enabled);
