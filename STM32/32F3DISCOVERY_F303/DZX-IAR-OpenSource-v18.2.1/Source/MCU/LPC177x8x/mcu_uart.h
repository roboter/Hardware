/*******************************************************************************************************************************************
    ...
    DZX | LPC177x8x | UART                                                                                                VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
#define REG_UART2      ((REG_UART*)0x40088000)
#define REG_UART3      ((REG_UART*)0x4009C000)
#define REG_UART4      ((REG_UART*)0x400A4000)
...
/*******************************************************************************************************************************************
    TYPE DEFINITIONS
*******************************************************************************************************************************************/
typedef struct LPC177X8X_UART UART;
typedef enum LPC177X8X_STOPBITS STOPBITS;
typedef enum LPC177X8X_PARITY PARITY;
typedef enum LPC177X8X_HANDSHAKE HANDSHAKE;

/***************************************************************************************************************************************//**

    An application-defined function that receives a callback upon data being received by a UART.
    @module     uart-lpc177x8x
...
/***************************************************************************************************************************************//**
    ...
    @param[in]  uart        A caller allocated uart instance to be opened.
