...
*******************************************************************************************************************************************/
#define REG_USBD0         ((REG_USBD*)0x2008C200)
...
typedef struct USBCLKSELBITFIELD {
    UINT32 USBDIV                  :5;
    UINT32                         :3;
    UINT32 USBSEL                  :2;
    UINT32                         :22;
...
#define REG_USBCLKCTRL                            REG_32(0x2008CFF4)
#define REG_OTGSTCTRL                             REG_32(0x2008C110)
#define REG_USBCLKSEL                             REG_32(0x400FC108)
#define REGBITS_USBCLKSEL                         REGBITS_32(0x400FC108, USBCLKSELBITFIELD)
#define REG_USBDEVINTCLR                          REG_32(0x2008C208)
#define REG_USBCMDCODE                            REG_32(0x2008C210)
#define REG_USBDEVINTST                           REG_32(0x2008C200)
#define REGBITS_USBDEVINTST                       REGBITS_32(0x2008C200, USBDEVINTSTBITFIELD)
#define REG_USBCMDDATA                            REG_32(0x2008C214)
#define REG_USBCTRL                               REG_32(0x2008C228)
#define REG_USBRXPLEN                             REG_32(0x2008C220)
#define REGBITS_USBRXPLEN                         REGBITS_32(0x2008C220, USBRXPLENBITFIELD)
#define REG_USBRXDATA                             REG_32(0x2008C218)
#define REG_USBTXPLEN                             REG_32(0x2008C224)
#define REG_USBCTRL                               REG_32(0x2008C228)
#define REGBITS_USBCTRL                           REGBITS_32(0x2008C228, USBCTRLBITFIELD)
#define REG_TDATA                                 REG_32(0x2008C21C)
#define REG_USBEPINTST                            REG_32(0x2008C230)
...
*******************************************************************************************************************************************/
typedef struct LPC177X8X_USBDCD {
