/*******************************************************************************************************************************************
    ...
    DZX | LPC177x8x | START                                                                                               VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
__vector_table_0x1c
        ...
        DCD     IRQ_Handler	  	        ; UART4 Handler
        DCD     IRQ_Handler              ; SSP2 Handler
        DCD     IRQ_Handler              ; LCD controller Handler
        DCD     IRQ_Handler              ; GPIO Handler
        DCD     IRQ_Handler              ; PWM0 Handler
        DCD     IRQ_Handler              ; EEPROM Handler
