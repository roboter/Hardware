/*******************************************************************************************************************************************
    ...
    DZX | LPC177x8x | IRQ                                                                                                 VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
enum LPC177X8X_IRQ {
    ...
    IRQ_SSP2,       /**< SSP 2 interrupt */
    IRQ_LCD,        /**< LCD controller interrupt */
    IRQ_GPIO,       /**< GPIO interrupts */
    IRQ_PWM0,       /**< PWM 0 interrupts */
    IRQ_EEPROM,     /**< EEPROM interrupts */
