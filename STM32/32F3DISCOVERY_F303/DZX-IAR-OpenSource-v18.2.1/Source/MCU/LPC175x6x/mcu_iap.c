...
/*******************************************************************************************************************************************
    PRIVATE DEFINITIONS
*******************************************************************************************************************************************/
#define IAPLOCATION                     0x1FFF1FF1  /**< The location of the entry point for the IAP driver */
...
*******************************************************************************************************************************************/
STATUS IAP_ReadPartID(PARTID* id)
{
    UINT32 results[2];
...
*******************************************************************************************************************************************/
STATUS IAP_PrepareSector(UINT32 startSector, UINT32 endSector)
{
    UINT32 result;
    UINT32 cmds[3];
...
*******************************************************************************************************************************************/
STATUS IAP_EraseSector(UINT32 startSector, UINT32 endSector)
{
    UINT32 result;
    UINT32 cmds[4];
