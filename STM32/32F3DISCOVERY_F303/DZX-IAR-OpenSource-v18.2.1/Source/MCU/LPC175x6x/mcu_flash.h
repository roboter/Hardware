/*******************************************************************************************************************************************
    ...
    DZX | LPC175x6x | FLASH                                                                                               VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
/***************************************************************************************************************************************//**
    ...
    Returns an indication of whether an address is the start of a sector.

    @param[in]  address     The target address.

    @return     TRUE if the address is the first entry within a sector; otherwise FALSE.
    @module     flash-lpc175x6x
...
*******************************************************************************************************************************************/
extern STATUS FLASH_EraseSector(UINT32 sector);
...
*******************************************************************************************************************************************/
extern STATUS FLASH_Write(UINT32 addr, const void* data, UINT32 nbytes);
