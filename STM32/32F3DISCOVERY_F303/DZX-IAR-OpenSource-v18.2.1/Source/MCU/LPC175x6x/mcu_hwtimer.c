/*******************************************************************************************************************************************
    ...
    DZX | LPC175x6x | HARDWARE TIMER                                                                                      VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
STATUS HWTIMER_Enable(HWTIMER* timer, UINT32 number)
{
    ...
    switch (number) {                                       /* Find the timer by number */
        case 0:
            ...
            REGBITS_PCONP.PCTIM0 = 1;
            REGBITS_PCLKSEL0.PCLKTIMER0 = 1;
            break;
        case 1:
            timer->REG = REG_TIMER1;
            REGBITS_PCONP.PCTIM1 = 1;
            REGBITS_PCLKSEL0.PCLKTIMER1 = 1;
            break;
        case 2:
            timer->REG = REG_TIMER2;
            REGBITS_PCONP.PCTIM2 = 1;
            REGBITS_PCLKSEL1.PCLKTIMER2 = 1;
            break;
        case 3:
            timer->REG = REG_TIMER3;
            REGBITS_PCONP.PCTIM3 = 1;
            REGBITS_PCLKSEL1.PCLKTIMER3 = 1;
            break;
        default:
...
STATUS HWTIMER_Disable(HWTIMER* timer)
{
    ...
    switch (timer->number) {                        /* Disable interrupts for the timer */
        case 0:
            ...
            REGBITS_PCONP.PCTIM0 = 0;
            break;
        case 1:
            IRQ_Disable(IRQ_TIMER1);
            REGBITS_PCONP.PCTIM1 = 0;
            break;
        case 2:
            IRQ_Disable(IRQ_TIMER2);
            REGBITS_PCONP.PCTIM2 = 0;
            break;
        case 3:
            IRQ_Disable(IRQ_TIMER3);
            REGBITS_PCONP.PCTIM3 = 0;
            break;
        default:
            return ERR_NULLREFERENCE;
    }
...
/***************************************************************************************************************************************//**
    ...
    @param[in]  arg         An optional argument object to be passed to the callback upon the match event. Can be NULL.
...
/***************************************************************************************************************************************//**
    ...
    ----------------------- | ------------------------------------------------------------------------------------------------------
     ...
     ERR_NOTSUPPORTED        | The specified timer channel is not supported.
     ERR_NULLREFERENCE        | One or more arguments are not correct.
