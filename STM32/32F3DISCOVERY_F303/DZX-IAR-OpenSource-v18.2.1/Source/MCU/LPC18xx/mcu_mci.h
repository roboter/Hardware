/*******************************************************************************************************************************************
    ...
    DZX | LPC18xx | MULTIMEDIA CARD INTERFACE                                                                             VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
/*******************************************************************************************************************************************
    TYPE DEFINITIONS
*******************************************************************************************************************************************/
typedef struct LPC18XX_MCI MCI;
typedef enum LPC18XX_MCITRANSFERMODE MCITRANSFERMODE;
typedef struct LPC18XX_MCIRESPONSE MCIRESPONSE;
typedef enum LPC18XX_MCIRESPONSETYPE MCIRESPONSETYPE;
typedef enum LPC18XX_MCICARDSTATE MCICARDSTATE;
...
struct LPC18XX_MCI {
    ...
    SIGNALSET signals;              /**< A signal set to block/signal threads */
