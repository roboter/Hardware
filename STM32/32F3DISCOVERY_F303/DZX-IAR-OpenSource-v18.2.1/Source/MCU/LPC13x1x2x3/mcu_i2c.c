...
/*******************************************************************************************************************************************
    PRIVATE VARIABLES
*******************************************************************************************************************************************/
static I2C* mcu_i2c[1];             /* Pointers to each of the open I2C ports */
...
STATUS I2C_Open(I2C* port, BYTE number, UINT32 clk)
{
    ...
    switch (number) {                                       /* By port number, power-on, select clock and enable NVIC interrupt */
        case 0:
            ...
            REGBITS_SYSAHBCLKCTRL.I2C = 1;                      /* Power ON the peripheral */
    ...
    REG_PRESETCTRL = 0x7;                                       /* Deassert reset signals */
