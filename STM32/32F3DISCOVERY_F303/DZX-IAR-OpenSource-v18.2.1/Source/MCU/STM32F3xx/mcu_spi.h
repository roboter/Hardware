...
typedef struct SPICR1BITFIELD {
    ...
    UINT32 RXONLY               :1;                             /* Receive only */
    UINT32 DFF                  :1;                             /* Data frame format */
...
typedef struct SPICR2BITFIELD {
    ...
    UINT32 NSSP                 :1;                             /* NSS pulse management */
    UINT32 FRF                  :1;                             /* Frame format */
    ...
    UINT32 DS                   :4;                             /* Data size */
    UINT32 FRXTH                :1;                             /* FIFO reception threshold */
    UINT32 LDMA_RX              :1;                             /* Last DMA transfer for reception */
    UINT32 LDMA_TX              :1;                             /* Last DMA transfer for transmission */
    UINT32                      :17;
} SPICR2BITFIELD;
...
typedef struct SPISRBITFIELD {
    ...
    UINT32 TIFRFE               :1;                             /* TI frame format error */
    UINT32 FRLVL                :2;                             /* FIFO reception level */
    UINT32 FTLVL                :2;                             /* FIFO transmission level */
    UINT32                      :19;
} SPISRBITFIELD;
...
typedef struct SPII2SCFGRBITFIELD {
    UINT32 CHLEN                :1;                             /* Channel length (number of bits per audio channel) */
    UINT32 DATLEN               :2;                             /* Data length to be transferred */
    UINT32 CKPOL                :1;                             /* Steady state clock polarity */
    UINT32 I2SSTD               :2;                             /* I2S standard selection */
    UINT32                      :1;
    UINT32 PCMSYNC              :1;                             /* PCM frame synchronization */
    UINT32 I2SCFG               :2;                             /* I2S configuration mode */
    UINT32 I2SE                 :1;                             /* I2S Enable */
    UINT32 I2SMOD               :1;                             /* I2S mode selection */
    UINT32                      :20;
} SPII2SCFGRBITFIELD;
...
typedef struct SPII2SPRBITFIELD {
    UINT32 I2SDIV               :8;                             /* I2S Linear prescaler */
    UINT32 ODD                  :1;                             /* Odd factor for the prescaler */
    UINT32 MCKOE                :1;                             /* Master clock output enable */
    UINT32                      :22;
} SPII2SPRBITFIELD;
