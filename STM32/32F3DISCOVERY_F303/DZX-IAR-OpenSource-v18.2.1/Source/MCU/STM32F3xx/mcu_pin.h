/*******************************************************************************************************************************************
    ...
    DZX | STM32F3xx | PIN                                                                                                 VERSION 18.2.1
    ------------------------------------------------------------------------------------------------------------------------------------
...
*******************************************************************************************************************************************/
#define REG_GPIOA       ((REG_GPIO*)0x48000000)
#define REG_GPIOB       ((REG_GPIO*)0x48000400)
#define REG_GPIOC       ((REG_GPIO*)0x48000800)
#define REG_GPIOD       ((REG_GPIO*)0x48000C00)
#define REG_GPIOE       ((REG_GPIO*)0x48001000)
#define REG_GPIOF       ((REG_GPIO*)0x48001400)

/***************************************************************************************************************************************//**

    Represents the registers for a GPIO port.
    @module     pin-stm32f3xx
...
/*******************************************************************************************************************************************
    TYPE DEFINITIONS
*******************************************************************************************************************************************/
typedef enum STM32F3XX_PORT PORT;
typedef enum STM32F3XX_PIN PIN;
typedef enum STM32F3XX_MODE MODE;
typedef enum STM32F3XX_EDGE EDGE;
typedef enum STM32F3XX_IOSPEED IOSPEED;
typedef enum STM32F3XX_RESISTOR RESISTOR;
