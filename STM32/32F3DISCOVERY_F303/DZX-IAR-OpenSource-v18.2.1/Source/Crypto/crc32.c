/*******************************************************************************************************************************************
    ...
    This provides support for calculating a 32-bit cyclic redundancy check (CRC) checksum.
...
/***************************************************************************************************************************************//**
    ...
    A lookup table to perform the check value calculation.
    @module     crc32
...
*******************************************************************************************************************************************/
UINT32 CRC32_Calculate(UINT32 initial, const void* data, UINT32 nbytes)
{
    UINT32 k;
    UINT32 crc;
    ...
    for (k = 0; k < nbytes; k++) {
        crc = CRC32_Table[(crc ^ ((BYTE*)data)[k]) & 0xFF] ^ (crc >> 8);
    }
