...
if(lcd_id==9325)
{
 ...
 {
   case 1:
    Lcd_WriteReg(0x0003,0x1000);		 //设置屏幕扫描方向   右>左  下>上 
	Lcd_WR_Reg(0x0022);					 
	break;
   case 2:
    Lcd_WriteReg(0x0003,0x1010);		 //设置屏幕扫描方向   左>右  下>上
	Lcd_WR_Reg(0x0022);					 
	break;
   case 3:
    Lcd_WriteReg(0x0003,0x1020);		 //设置屏幕扫描方向   右>左  上>下
	Lcd_WR_Reg(0x0022);					
	break;
   case 4:
    Lcd_WriteReg(0x0003,0x1030);		 //设置屏幕扫描方向   左>右  上>下 
	Lcd_WR_Reg(0x0022);					 
	break;
   case 5:
    Lcd_WriteReg(0x0003,0x1008);		 //设置屏幕扫描方向   下>上  右>左 
	Lcd_WR_Reg(0x0022);					 
	break;
   case 6:
    Lcd_WriteReg(0x0003,0x1018);		 //设置屏幕扫描方向   下>上  左>右
	Lcd_WR_Reg(0x0022);					 
	break;
   case 7:
    Lcd_WriteReg(0x0003,0x1028);		 //设置屏幕扫描方向   上>下  右>左
	Lcd_WR_Reg(0x0022);					 
	break;
   case 8:
    Lcd_WriteReg(0x0003,0x1038);		 //设置屏幕扫描方向   上>下  左>右
	Lcd_WR_Reg(0x0022);					 
	break;
 }
}
