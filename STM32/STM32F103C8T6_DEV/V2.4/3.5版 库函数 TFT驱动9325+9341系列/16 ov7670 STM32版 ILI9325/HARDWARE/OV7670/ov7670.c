...
{		 		
	...
	if(EXTI_GetITStatus(EXTI_Line2)==SET)//是2线的中断
	{     
		if(ov_sta<2)
		{
			if(ov_sta==0)
...
//	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_2; 	//PD2 输入 上拉
...
// 	GPIO_Init(GPIOD, &GPIO_InitStructure);
 	...
 	GPIO_InitStructure.GPIO_Pin =GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3|GPIO_Pin_8;	 // 端口配置
