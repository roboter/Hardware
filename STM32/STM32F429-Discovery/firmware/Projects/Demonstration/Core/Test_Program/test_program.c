...
void start_test(void)
{
  ...
  LCD_DisplayStringLine(LCD_LINE_3,(uint8_t*)"    V1.0.3     ");
...
/* TP TEST ********************************************************************/  
  ...
  /* TP Test1 pooling mode */
  TP_Test1();
   /* TP Test1 interrupt mode */
  TP_Test2();
...
/**
* @brief   Detect motion direction to test MEMS using interrupt mode.
* @param  None
* @retval None
*/
void MEMS_Test2(void)
{  
  /*  to display message when External line 1 interrupt is happen*/ 
  Test_mode = 2;
  ...
  LCD_Clear(LCD_COLOR_BLUE);
  LCD_SetTextColor(LCD_COLOR_BLACK); 
  LCD_DisplayStringLine(LCD_LINE_1,(uint8_t*)"   MEMS TEST2  ");
  LCD_DisplayStringLine(LCD_LINE_2,(uint8_t*)"INTERRUPT MODE ");
  LCD_DisplayStringLine(LCD_LINE_5,(uint8_t*)"MOVE DISCOVERY ");
  ...
  else
  {
    ...
    LCD_DisplayStringLine(LCD_LINE_7,(uint8_t*)" MEMS NOT YET  ");
    LCD_DisplayStringLine(LCD_LINE_9,(uint8_t*)"   DETECTED    ");
    STM_EVAL_LEDOn(LED4);      
  }
...
void TP_Test1(void)
{
  ...
  if (IOE_Config() == IOE_OK)
  {
    ...
    {
      LCD_SetTextColor(LCD_COLOR_RED); 
      LCD_DisplayStringLine(LCD_LINE_1,(uint8_t*)"    TP TEST1   ");
      LCD_DisplayStringLine(LCD_LINE_3,(uint8_t*)"  PLEASE TOUCH ");
      ...
      if ((TP_State->TouchDetected) && (TP_State->Y < 280) && (TP_State->Y > 200) && (TP_State->X > 80) && (TP_State->X < 160))
      {
        ...
        LCD_Clear(LCD_COLOR_GREEN);
        LCD_SetTextColor(LCD_COLOR_BLACK); 
        LCD_DisplayStringLine(LCD_LINE_1,(uint8_t*)"   TP TEST1 OK ");
        LCD_DisplayStringLine(LCD_LINE_3,(uint8_t*)"      PUSH     ");
        LCD_DisplayStringLine(LCD_LINE_5,(uint8_t*)"  USER BUTTON  ");
        LCD_DisplayStringLine(LCD_LINE_7,(uint8_t*)"   TO GO ON    ");
        LCD_DisplayStringLine(LCD_LINE_9,(uint8_t*)"   TP TEST2    ");
...
/**
* @brief  Detect screen touch in interrupt mode.
* @param  None
* @retval None
*/
void TP_Test2(void)
{
  /*  to display message when IOE interrupt line is happen*/ 
  Test_mode = 1; 
  ...
  {
    LCD_SetTextColor(LCD_COLOR_RED); 
    LCD_DisplayStringLine(LCD_LINE_1,(uint8_t*)"    TP TEST2   ");
    LCD_DisplayStringLine(LCD_LINE_2,(uint8_t*)"INTERRUPT MODE ");
    LCD_DisplayStringLine(LCD_LINE_5,(uint8_t*)"  PLEASE TOUCH ");
    LCD_DisplayStringLine(LCD_LINE_7,(uint8_t*)"  THE SCREEN   ");          
  }  
  else
  {
    /* LCD display message */
