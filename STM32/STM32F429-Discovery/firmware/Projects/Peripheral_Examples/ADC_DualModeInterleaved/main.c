...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/ 
  #define MESSAGE1   "Dual ADC Interleaved"
  #define MESSAGE1_1 "DMA mode3 example    " 
  #define MESSAGE2   " ADC Ch13 Conv " 
  #define MESSAGE2_1 "    6Msps      "
...
static void Display(void)
{
  ...
  uwADC1ConvertedVoltage = uwADC1ConvertedValue *3000/0xFF;
  ...
  uwADC2ConvertedVoltage = uwADC2ConvertedValue *3000/0xFF;
