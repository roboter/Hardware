...
# 37 "../main.c" 2
# 1 "../../../Utilities\\gd32e230c_start.h" 1
# 46 "../../../Utilities\\gd32e230c_start.h"
typedef enum
{
    LED1 = 0,
    LED2 = 1,
...
# 99 "../../../Utilities\\gd32e230c_start.h"
...
static const uint32_t GPIO_PORT[4U] = {((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U)};

static const uint32_t GPIO_PIN[4U] = {((uint32_t)((uint32_t)0x01U<<(0)))};
...
void SetColorBit(boolean one)
{
  if (one)
  {
    (*(volatile uint32_t *)(uint32_t)((((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U)) + 0x18U)) = ((uint32_t)((uint32_t)0x01U<<(0)));
     __asm(
      ".rept 20 \n\t"
      "nop \n\t"
      ".endr \n\t"
    ...
    (*(volatile uint32_t *)(uint32_t)((((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U)) + 0x28U)) = (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
     __asm(
      ".rept 8 \n\t"
      "nop \n\t"
      ".endr \n\t"
...
int main(void)
{
  ...
  gpio_bit_reset(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), ((uint32_t)((uint32_t)0x01U<<(0))));
...
static const rcu_periph_enum GPIO_CLK[4U] = {RCU_GPIOB};

void gd_eval_led_init_my(led_typedef_enum lednum)
{

    rcu_periph_clock_enable(GPIO_CLK[lednum]);

    gpio_mode_set(GPIO_PORT[lednum], (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), GPIO_PIN[lednum]);
    ...
    (*(volatile uint32_t *)(uint32_t)((GPIO_PORT[lednum]) + 0x28U)) = GPIO_PIN[lednum];
}
...
void gpio_config(void)
{
   ...
   rcu_periph_clock_enable(RCU_GPIOB);
    ...
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(0))));
    gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)),((uint32_t)((uint32_t)0x01U<<(0))));
    gpio_af_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(0))));
}
...
void timer_config(void)
{
    ...
    timer_deinit(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U));
    ...
    timer_init(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U),&timer_initpara);


    timer_ocintpara.ocpolarity = ((uint16_t)0x0000U);
    timer_ocintpara.outputstate = ((uint32_t)0x00000001U);

    timer_channel_output_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U),((uint16_t)0x0000U),&timer_ocintpara);

    timer_channel_output_pulse_value_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U),((uint16_t)0x0000U),24999);
    timer_channel_output_mode_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U),((uint16_t)0x0000U),((uint16_t)0x0060U));
    timer_channel_output_shadow_config(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U),((uint16_t)0x0000U),((uint16_t)0x0000U));


    timer_auto_reload_shadow_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U));

    timer_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U));
}



void gd_eval_led_toggle_my(led_typedef_enum lednum)
{
    (*(volatile uint32_t *)(uint32_t)((GPIO_PORT[lednum]) + 0x2CU)) = GPIO_PIN[lednum];
}
