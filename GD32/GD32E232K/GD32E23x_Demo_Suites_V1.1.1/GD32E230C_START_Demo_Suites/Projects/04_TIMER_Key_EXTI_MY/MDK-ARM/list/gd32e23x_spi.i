# 1 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c" 2
# 36 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
...
# 37 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c" 2
# 58 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_i2s_deinit(uint32_t spi_periph)
{
    switch(spi_periph) {
...
# 117 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
ErrStatus spi_init(uint32_t spi_periph, spi_parameter_struct *spi_struct)
{
...
# 227 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void i2s_init(uint32_t spi_periph, uint32_t mode, uint32_t standard, uint32_t ckpl)
{
    uint32_t reg = 0U;
...
# 273 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void i2s_psc_config(uint32_t spi_periph, uint32_t audiosample, uint32_t frameformat, uint32_t mckout)
{
...
# 325 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void i2s_enable(uint32_t spi_periph)
{
...
# 395 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_dma_enable(uint32_t spi_periph, uint8_t dma)
{
...
# 414 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_dma_disable(uint32_t spi_periph, uint8_t dma)
{
    if(((uint8_t)0x00U) == dma) {
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(1))));
...
# 433 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_transmit_odd_config(uint32_t spi_periph, uint16_t odd)
{
...
# 451 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_receive_odd_config(uint32_t spi_periph, uint16_t odd)
{
...
# 468 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
ErrStatus spi_i2s_data_frame_format_config(uint32_t spi_periph, uint16_t frame_format)
{
    uint32_t reg;
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph) {
...
# 502 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_fifo_access_size_config(uint32_t spi_periph, uint16_t fifo_access_size)
{
...
# 520 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_bidirectional_transfer_config(uint32_t spi_periph, uint32_t transfer_direction)
{
...
# 538 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_i2s_data_transmit(uint32_t spi_periph, uint16_t data)
{
    uint32_t reg, byten;
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph) {
...
# 585 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_crc_polynomial_set(uint32_t spi_periph, uint16_t crc_poly)
{
...
# 614 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_crc_length_set(uint32_t spi_periph, uint16_t crc_length)
{
...
# 665 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
uint16_t spi_crc_get(uint32_t spi_periph, uint8_t crc)
{
...
# 815 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
FlagStatus spi_i2s_flag_get(uint32_t spi_periph, uint32_t flag)
{
...
# 854 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_i2s_interrupt_enable(uint32_t spi_periph, uint8_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)interrupt;
}
# 871 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_i2s_interrupt_disable(uint32_t spi_periph, uint8_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= ~(uint32_t)interrupt;
}
# 891 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
FlagStatus spi_i2s_interrupt_flag_get(uint32_t spi_periph, uint8_t interrupt)
{
