# 1 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c" 2
# 36 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
...
# 37 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c" 2
...
# 72 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void nvic_system_reset(void)
{
    __NVIC_SystemReset();
}
# 86 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void nvic_vector_table_set(uint32_t nvic_vict_tab, uint32_t offset)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = nvic_vict_tab | (offset & ((uint32_t)0x1FFFFF80));
    __builtin_arm_dsb(0xF);
}
# 103 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void system_lowpower_set(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (uint32_t)lowpower_mode;
}
# 119 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void system_lowpower_reset(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= (~(uint32_t)lowpower_mode);
}
# 133 "../../../../GD32E23x_Firmware_Library/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void systick_clksource_set(uint32_t systick_clksource)
{
